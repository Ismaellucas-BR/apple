import BgHero from "../../assets/imgs/bgHero.webp";
import Macbook from "../../assets/imgs/hero_sticker_mba__b0ht7774wpaq_small_2x.png";
import Airpad from "../../assets/imgs/hero_sticker_ipadair__bk6ffplndvte_small_2x.png";
...
export default function FirstSection() {
  return (
    <section
      ...
      className="flex flex-col justify-center items-center gap-3 py-20">
      <div className="flex flex-col justify-center items-center gap-1 leamsi-1">
        <h2 className="flex flex-col justify-center items-center relative text-black">
          <svg
            className="relative bubble-svg fill-[#007aff] w-2/3"
          ...
          <figure className="absolute top-0 right-0 icon icon-mba unit-image unit-image-bts-2025-hero-sticker-mba -translate-y-1/2 z-20">
            <img className="h-[4.7rem] w-[6.375rem]" src={Macbook} alt="" />
          </figure>
          <figure className=" absolute top-6 right-8 icon icon-ipadair unit-image unit-image-bts-2025-hero-sticker-ipadair z-10">
            <img className="h-[4,4375rem] w-[3.625rem]" src={Airpad} alt="" />
          </figure>
        </h2>
        <div className="flex flex-col justify-center items-center">
          <svg
            viewBox="0 0 614 94"
            className="w-2/3 h-auto fill-[#007aff] "
            preserveAspectRatio="none"
            xmlns="http://www.w3.org/2000/svg">
        ...
        <svg
          viewBox="0 0 628 480"
          className="w-2/3 h-auto fill-[#007aff] mt-3"
          preserveAspectRatio="none"
          xmlns="http://www.w3.org/2000/svg">
      ...
      <Link
        to="#"
        className="py-1.5 px-6 border border-azulClaro rounded-full shadow font-apple text-[0.875rem] text-azulClaro">
        Comprar
      </Link>
    </section>
  );
