...
import BgIPad from "../../assets/imgs/home/promo_ipad_air_avail__6i02t7nujr62_small_2x.jpg";
import LogoIPad from "../../assets/imgs/home/promo_logo_ipadair__frwnnsqveeye_medium_2x.png";
    ...
    <section
      ...
      <div className="flex flex-col justify-center items-center w-full gap-2 pt-10">
        <div className="flex justify-center items-center gap-2 w-[60%]">
          <img className="w-[7.125rem] h-[1.625rem]" src={LogoIPad} alt="" />
        </div>
        <p className="font-apple font-normal text-[1.1875rem] text-center leading-6 w-[85%]">
          Agora com a potência do chip M3.
        </p>
